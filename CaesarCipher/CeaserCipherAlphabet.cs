...
/// </copyright>
///
/// <summary>   Simple class providing alphabents that can be used with the <see cref="CaesarCipher.CeaserCipherEncryption"/> class.</summary>
namespace CaesarCipher
{
    using System.Collections.Immutable;

    public static class CeaserCipherAlphabet
    {
